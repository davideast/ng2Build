System.register("core/test/compiler/viewport_spec", ["test_lib/test_lib", "core/compiler/view", "core/compiler/viewport", "facade/dom", "facade/collection", "di/di", "core/compiler/element_injector", "change_detection/change_detection"], function($__export) {
  "use strict";
  var __moduleName = "core/test/compiler/viewport_spec";
  var describe,
      xit,
      it,
      expect,
  ...
  function main() {
    describe('viewport', (function() {
      ...
      describe('should update injectors and parent views.', (function() {
        ...
        it('hydrating should update rootElementInjectors and parent RR', (function() {
        ...
        it('dehydrating should update rootElementInjectors and parent RR', (function() {
          viewPort.insert(fancyView);
          viewPort.remove();
          ListWrapper.forEach(fancyView.rootElementInjectors, (function(inj) {
...
//# sourceMappingURL=/Users/deast/Angular/angular/modules/core/test/compiler/viewport_spec.map
